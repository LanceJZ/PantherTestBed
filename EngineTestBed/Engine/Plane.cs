...
namespace Engine
{
    public class Plane : PositionedObject, IDrawComponent
    {
        ...
        {
            PlaneBasicEffect = new BasicEffect(Core.GraphicsDM.GraphicsDevice);
        }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            PlaneBasicEffect.View = Core.DefaultCamera.View;
            PlaneBasicEffect.Projection = Core.DefaultCamera.Projection;
            Core.GraphicsDM.GraphicsDevice.SetVertexBuffer(PlaneVertexBuffer);
        }
        ...
        public void Draw()
        {
            ...
            {
                pass.Apply();
                Core.GraphicsDM.GraphicsDevice.DrawUserPrimitives<VertexPositionTexture>(PrimitiveType.TriangleList, Verts, 0, 2);
            }
        }

        public void Create(Texture2D texture)
        {
            PlaneVertexBuffer = new VertexBuffer(Core.GraphicsDM.GraphicsDevice,
